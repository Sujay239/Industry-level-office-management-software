...
import { Calendar, Clock, Link as LinkIcon, Users, Trash2, ExternalLink, Plus, Eye, Pencil } from "lucide-react";
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="url" value={joinUrl} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setJoinUrl(e.target.value)} placeholder="https://meet.google.com/..." className="pl-9 bg-slate-50 dark:bg-slate-900 dark:text-white" />
                            </div>
                        </div>
                ...
                <DialogContent className="sm:max-w-[500px] max-h-[85vh] overflow-y-auto bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800">
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="relative">
                                <LinkIcon className="absolute left-3 top-3 h-4 w-4 text-slate-400" />
                                <Input id="edit-url" value={joinUrl} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setJoinUrl(e.target.value)} placeholder="https://meet.google.com/..." className="pl-9 bg-slate-50 dark:bg-slate-900 dark:text-white" />
                            </div>
                        </div>
